...
public final class OperandM80BCD implements OperandFPU {
    ...
    public String toString() {
        ...
        return String.format("m80bcd ptr [%s:%s]", m_segment.toString(), m_offset.toString());
    }
}
