...
public final class OperandM64Double implements OperandFPU {

    private final Intel80386 m_cpu;
    private final Segment m_segment;
    private final Pointer m_offset;
    
    public OperandM64Double(Intel80386 cpu,
                            Segment segment,
                            Pointer offset) {
    ...
    public void setValue(double value) {
        ...
        int lo = (int)(result & 0xffffffffl);
        int hi = (int)((result >>> 32) & 0xffffffffl);
        
        m_cpu.writeMEM32(m_segment, m_offset.getAddress(), lo);
        m_cpu.writeMEM32(m_segment, m_offset.getAddress() + 4, hi);
    }
    
    @Override
    public String toString() {
        
        return String.format("m64fp ptr [%s:%s]", m_segment.toString(), m_offset.toString());
    }
}
