...
public final class OperandM32Float implements OperandFPU {

    private final Intel80386 m_cpu;
    private final Segment m_segment;
    private final Pointer m_offset;
    
    public OperandM32Float(Intel80386 cpu,
                           Segment segment,
                           Pointer offset) {
    ...
    public double getValue() {
        ...
        return Float.intBitsToFloat(
            ...
            m_cpu.readMEM32(m_segment, m_offset.getAddress())
        );
    }
    ...
    public void setValue(double value) {
        ...
        int result = Float.floatToRawIntBits((float)value);
    ...
    public String toString() {
        ...
        return String.format("m32fp ptr [%s:%s]", m_segment.toString(), m_offset.toString());
    }
}
