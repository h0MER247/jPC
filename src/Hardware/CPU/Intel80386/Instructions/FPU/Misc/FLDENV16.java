...
public final class FLDENV16 extends Instruction {
    
    private final Segment m_segment;
    private final Pointer m_offset;
    
    public FLDENV16(Intel80386 cpu,
                    Segment segment,
                    Pointer offset) {
    ...
    public void run() {
        ...
        m_cpu.FPU.setStatus(m_cpu.readMEM16(m_segment, addr + 2));
        m_cpu.FPU.setTags(m_cpu.readMEM16(m_segment, addr + 4));
    }
