...
public final class FSTP extends Instruction {

    private final OperandFPU m_destination;
    
    public FSTP(Intel80386 cpu,
    ...
    public void run() {
        ...
        m_destination.setValue(m_cpu.FPU.getST0());
        m_cpu.FPU.popStack();
    }
    ...
    public String toString() {
        ...
        return String.format("fstp %s", m_destination.toString());
    }
}
