...
public final class FSUBP extends Instruction {
    ...
    public String toString() {
        ...
        return String.format("fsubp %s, %s, %s", m_destination.toString(), m_arg1.toString(), m_arg2.toString());
    }
}
