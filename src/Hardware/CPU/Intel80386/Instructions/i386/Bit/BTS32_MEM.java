...
public final class BTS32_MEM extends Instruction {
    
    private final OperandMemory m_memory;
    private final Operand m_bit;
    
    public BTS32_MEM(Intel80386 cpu,
    ...
    public String toString() {
        ...
        return String.format("bts %s, %s", m_memory.toString(), m_bit.toString());
    }
}
