...
public final class LIDT16 extends Instruction {
    
    private final Operand m_limit;
    private final Operand m_base;
    
    public LIDT16(Intel80386 cpu,
                  Operand limit,
                  Operand base) {
    ...
    public void run() {
        ...
        m_cpu.IDT.setLimit(m_limit.getValue());
        m_cpu.IDT.setBase(m_base.getValue() & 0x00ffffff);
    }
    
    @Override
    public String toString() {
        
        return String.format("lidt %s", m_limit.toString());
    }
}
