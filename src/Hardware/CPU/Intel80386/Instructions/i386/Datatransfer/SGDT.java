...
public final class SGDT extends Instruction {
    ...
    public void run() {
        ...
        m_destinationLimit.setValue(m_cpu.GDT.getLimit());
        m_destinationBase.setValue(m_cpu.GDT.getBase());
    }
    
    @Override
    public String toString() {
        
        return String.format("sgdt %s", m_destinationLimit.toString());
    }
}
