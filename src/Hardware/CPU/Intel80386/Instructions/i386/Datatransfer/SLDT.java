...
public final class SLDT extends Instruction {
    
    private final Operand m_destination;
    
    public SLDT(Intel80386 cpu,
                Operand destination) {
    ...
    public void run() {
        ...
        m_destination.setValue(m_cpu.LDT.getSelector());
    }
    
    @Override
    public String toString() {
        
        return String.format("sldt %s", m_destination.toString());
    }
}
