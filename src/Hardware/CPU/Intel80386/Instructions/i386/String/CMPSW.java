...
public final class CMPSW extends Instruction {
    ...
    public void run() {
        ...
        int arg1 = m_cpu.readMEM16(m_srcSegment, srcIndex);
        int arg2 = m_cpu.readMEM16(m_cpu.ES, destIndex);
    ...
    public String toString() {
        ...
        return String.format("%s: cmpsw", m_srcSegment.toString());
    }
}
