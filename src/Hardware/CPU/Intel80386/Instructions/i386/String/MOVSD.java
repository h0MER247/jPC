...
public final class MOVSD extends Instruction {
    ...
    public void run() {
        ...
        m_cpu.writeMEM32(m_cpu.ES, destIndex, m_cpu.readMEM32(m_srcSegment, srcIndex));
    ...
    public String toString() {
        ...
        return String.format("%s: movsd", m_srcSegment.toString());
    }
}
