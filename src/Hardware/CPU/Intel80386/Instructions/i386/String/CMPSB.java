...
public final class CMPSB extends Instruction {
    ...
    public void run() {
        ...
        int arg1 = m_cpu.readMEM8(m_srcSegment, srcIndex);
        int arg2 = m_cpu.readMEM8(m_cpu.ES, destIndex);
    ...
    public String toString() {
        ...
        return String.format("%s: cmpsb", m_srcSegment.toString());
    }
}
