...
public final class BOUND16 extends Instruction {
    ...
    public void run() {
        ...
        int index = signExtend16To32(m_index.getValue());
        int low = signExtend16To32(m_lowBoundary.getValue());
        int high = signExtend16To32(m_highBoundary.getValue());
