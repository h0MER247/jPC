...
public final class RET_NEAR extends Instruction {

    private final Operand m_stackDisplacement;
    private final boolean m_is32;
    
    public RET_NEAR(Intel80386 cpu,
    ...
    public void run() {
        ...
        try {
            ...
            // Load EIP
            if(m_is32)
                m_cpu.EIP.setValue(m_cpu.popStack32());
            else
                m_cpu.EIP.setValue(m_cpu.popStack16());
    ...
    public String toString() {
        ...
        if(m_stackDisplacement != null)
            return String.format("ret %s", m_stackDisplacement.toString());
        else
            return "ret";
    }
}
