...
public final class Pointer32BaseDisplacement implements Pointer {

    private final Register m_base;
    private final int m_displacement;

    public Pointer32BaseDisplacement(Register base,
                                     int displacement) {
    ...
    public int getAddress() {
        ...
        return m_base.getValue() + m_displacement;
    }

    @Override
    public String toString() {

        return String.format("%s + 0x%08X", m_base.toString(), m_displacement);
    }
}
